...
HD_PWD='X:/EC311/lab4_mike/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore_FSM.tcl
